...
<main className="holder">
        <div className="historia">
            <h2>Hola!</h2>
            <p>A continuación, te mostramos algunas preparaciones fáciles
                y prácticas para mejorar tus comidas.</p>
            <p>Son recetas dulces para variar desayunos y meriendas. Son super deliciosas y saciantes!</p>
        ...
        <div className="staff">
            ...
            <div className="personas">
                <div className="persona">
                    ...
                    <h5>Muffin sin harinas</h5>
                    <br />
                    <h6>Conservalos en la heladera y
                        comelos fríos ; ideal como postre!</h6>
                    <p>Procesar o mixear 3 bananas, 5 cucharadas soperas de cacao amargo en polvo, 2 huevos, 1
                ...
                <div className="persona">
                    ...
                    <p>Procesar la avena con el polvo de hornear.
                ...
                <div className="persona">
                    ...
                    <h6>Los dátiles son ideales para endulzar
                        ...
                        natural.</h6>
                    <p>Procesar los dátiles junto con el cacao
